    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <?php 
                  ...
                  $date1 = date("Y-m-d");
                  $date2 = date("Y-m-d");
                if (isset($_POST['all_sales_report'])) {
                 ...
                 if($_SESSION['role_id'] == 3){
                    ...
                    AND total_sales.date_done BETWEEN '$date1' AND '$date2' 
                    AND total_sales.payment_mode !='Refounded' AND ser_status='1'";
                    ...
                    <td>
                     <small>
                      <div class="" padding: 0px;>
                        <button type="button" class="btn btn-primary btn-sm" style="padding-top: 0px;padding-bottom: 0px; border-radius: 10px;"><i class="fas fa-edit"></i></button>
             
                        <button type="button" class="btn btn-danger btn-sm" style="padding-top: 0px;padding-bottom: 0px; border-radius: 5px;"><i class="fas fa-trash"> </i></button>
                      </div>
                      </small>
                    </td>
                  </tr>
          ...
          <div class="card-footer small text-centered" >
            <center>
              <strong style="font-size: 1.5em;float: left;">
                <span class="alert alert-warning">LOAN: 
                  <?php echo number_format($loan_amount)." frw"; ?>
                </span>
              </strong>
              <strong style="font-size: 1.5em; ">
                <span class="alert alert-primary">TRANSFER: 
                  <?php echo number_format($transfer_amount)." frw"; ?>
                </span>
              </strong>
              <strong style="font-size: 1.5em;margin-left: 4em;">
                <span class="alert alert-info">PAID: 
                  <?php echo number_format($paid_amount)." frw"; ?>
                </span>
              </strong>
