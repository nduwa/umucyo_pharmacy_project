    ...
    <div class="card-body">
      <div class="table-responsive">
       ...
       if($_SESSION['role_id'] == 3){
        ...
        $sql = "SELECT *,sum(product_quantity) as quantity FROM `purchase_medical_product`INNER JOIN `medical_product` ON purchase_medical_product.product_name = medical_product.product_ID
        INNER JOIN `login` ON purchase_medical_product.user_id = login.user_id 
        WHERE purchase_medical_product.institution_code = '$_SESSION[institution_code]'
        AND purchase_medical_product.purchase_status ='1' GROUP by purchase_medical_product.product_name";
           ...
           ?>
            <tr>
              ...
              <td>
                ...
                <?php 
                   echo '<i style="float:left; color:blue;margin-top:1%; ">Over!!</i>'; 
