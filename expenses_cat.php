              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>
                      <div class="xs">
                        <button type="button" class="btn btn-danger btn-sm" style="padding-top: 0px;padding-bottom: 0px; border-radius: 10px;"><i class="fas fa-trash"> Delete</i></button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #1DB0D8;">
            <h4 class="modal-title"><i class="fas fa-plus"> ADD EXPENSE CATEGORY</i> </h4>
        ...
        <form action="/action_page.php">
          <div class="form-group">
            <label for="category">Expense:</label>
          ...
          <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-plus"> ADD</i></button>
        </form>
        </div>
        <div class="modal-footer">
