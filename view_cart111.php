        ...
        <tbody>
          <?php
            ...
            INNER JOIN medical_product ON purchase_medical_product.product_name = medical_product.product_ID
              WHERE purchase_medical_product.product_name IN (".implode(',',$_SESSION['cart']).") 
            ...
            $query = $conn->query($sql);
              while($row = $query->fetch_assoc()){
                ...
                <tr>
                  <td>
                    <a href="delete_item.php?id=<?php echo $row['product_ID']; ?>&index=<?php echo $index; ?>" class="btn btn-danger btn-sm"><span class="fas fa-trash"></span></a>
                  </td>
                  ...
                  <td>
                    <?php 
                     ...
                     if (isset($_SESSION['batch_number'])) {
                      ...
                      ?>
                    <select name="batch_Number[]" id="batchh" required="required">
                ...
                $(document).ready(function(){    
                     $('#batchh').change(function(){  
                          var qty= $('#sel1').val();  
                          //var destination = $('#sel2').val(); 
                  var batch_number=$('#batchh').val();
                 ...
                 {  
                  ...
                  <td><input type="text" disabled="disabled" name="batch_number" value="<?php echo $f; ?>"  /></td>
                  <td >
