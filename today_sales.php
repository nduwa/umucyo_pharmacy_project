    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sales of today</li>
        </ol>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php 
                  $today = date('Y-m-d');
                  $sql_today_sales = "SELECT * ,  SUM(sub_total) AS transaction_amount FROM `transactions` INNER JOIN `phar_branch` ON transactions.Branch= phar_branch.branch_ID
               INNER JOIN total_sales ON total_sales.transaction_ID = transactions.TRANSACTION_NUMBER
                     WHERE transactions.done_at='$today' GROUP BY transactions.TRANSACTION_ID";
                    ...
                    <td>
                     <small>
                      <div class="" padding: 0px;>
                       <a href="sales_details?$inv=<?php echo $row['transaction_ID']; ?>">
                       <button type="button" class="btn btn-success btn-sm" style="padding-top: 0px;padding-bottom: 0px; border-radius: 5px;"><i class="fas fa-list"> </i>
                        Details
                       </button></a>
                      </div>
                      </small>
